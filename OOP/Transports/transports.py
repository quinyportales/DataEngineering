...
class Transport(ABC, Vehicle):
  ...
  def get_total_vehicles():
      '''To check how many vehicles I created'''
...
class Ship(Transport):
    ...
    def get_transport_type(self):
        return f'Type {Ship.transport_type} with a max capacity of {self.max_capacity} persons to transport'
...
class Plane(Transport):
  ...
  #overiding the magic methods
  def __str__(self):
        return (f'This is a plane {self.transport_type}, type of {self.type_of_plane} with a max capacity of {self.max_capacity} persons to transport \n'
               f'Max speed {self.get_max_speed()}'
               )
  ...
  def get_transport_type(self):
       return (f'{self.transport_type} with a max capacity of {self.max_capacity} persons to transport \n')
