"""Module defining vthe super class Vehicle"""
...
class Vehicle():
    ...
    def set_common_attributes(cls, manufacture_year, is_operational):
        """Set manufacture_year and fuel_type 
        for all instances of this class or subclasses."""
    ...
    def get_common_attributes(cls):
        ...
        return (f"Manufacture Year: {cls.manufacture_year}"
                f'Is Operational Status {cls.is_operational}')
