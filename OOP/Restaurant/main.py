...
from menu.item import Item, OrderedItem
from menu.stock import Stock
from order.order_class import Order
from order.delivery import Delivery
...
if __name__ == '__main__':
    ...
    menu.add_menu(item1.add_item())
    menu.add_menu(item2.add_item())
    menu.add_menu(item3.add_item())
    menu.add_menu(item4.add_item())
    menu.add_menu(item5.add_item())
    ...
    customer1.add_to_historial(ordered_item1.date, ordered_item1.item_name)
    customer1.add_to_historial(ordered_item2.date, ordered_item2.item_name)
